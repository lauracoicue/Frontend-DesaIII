...
const Form = () => {
    return(
        <div className="bg-white">
            ...
            <div>
                <div className="mt-20">
                    <label htmlFor="" className="font-serif font-medium text-lg">Email Address</label>
                    <input 
                ...
                <div className="mt-12">
                    <label htmlFor="" className="font-serif font-medium text-lg">Password</label>
                    <input 
                        type="text"
                        className="w-full border-2 border-gray-300  p-3 rounded-xl mt-1 mx-1"
                ...
                <div className="flex flex-col items-center gap-4 p-10 mt-6">
                    <div>
                ...
                <div className="-mt-7 flex flex-col gap-y-1">
                    <button className="active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out border border-blue-950 bg-blue-950 text-white py-3 px-32 rounded-xl text-center font-bold mt-6">Iniciar sesión</button>
